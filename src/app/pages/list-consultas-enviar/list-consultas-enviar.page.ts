...
@Component({
  selector: 'app-list-consultas-enviar',
  templateUrl: './list-consultas-enviar.page.html',
  styleUrls: ['./list-consultas-enviar.page.scss'],
})
export class ListConsultasEnviarPage implements OnInit {
  ...
  async searchConsulta($event) {
    ...
    if (value && value.length >= 3) {
      ...
      this.consultas = await this.entConsultaEnviar.searchByNameFunc(value,
      status, this.lastLogin.id_medico_vila, this.lastLogin.id_medico_tcmed);
